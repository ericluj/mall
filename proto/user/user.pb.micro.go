...
type UserService interface {
	...
	QueryUser(ctx context.Context, in *UserRequest, opts ...client.CallOption) (*UserResponse, error)
}
...
func (c *userService) QueryUser(ctx context.Context, in *UserRequest, opts ...client.CallOption) (*UserResponse, error) {
...
func RegisterUserHandler(s server.Server, hdlr UserHandler, opts ...server.HandlerOption) error {
	type user interface {
		...
		QueryUser(ctx context.Context, in *UserRequest, out *UserResponse) error
	}
	type User struct {
		user
	}
...
func (h *userHandler) QueryUser(ctx context.Context, in *UserRequest, out *UserResponse) error {
